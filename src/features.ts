 ...
 *   similarRefine  the "more/less like this" refinement calls `onLockedFeature`; the one-shot
 *                  Find Similar it refines is NOT gated by this.
...
export type BrowseFeature = 'sortByValue' | 'priceFilter' | 'similarRefine' | 'colorSearch';
